...
int main(int argc, char* argv[]) {
  ...
  if(targetArr[0] == 'D') {
    ...
    fileDataName = Form("~/proyecto/Pt2Broadening_multi-pion/Data/MaxE_%s2.root", solidTarget);
  } else{
    m = n+1;
    ...
    fileDataName = Form("~/proyecto/Pt2Broadening_multi-pion/Data/MaxE_%s.root", targetArr);
  }
